...
@Configurable // Panels
public class RLoopAuto extends OpMode {
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            ...
            Path2 = follower.pathBuilder().addPath(
                            new BezierCurve(
                                    new Pose(91.636, 106.137),
                                    new Pose(101.548, 73.444),
                                    new Pose(131.513, 60.017)
                            )
            ...
            Path3 = follower.pathBuilder().addPath(
                            new BezierCurve(
                                    new Pose(131.513, 60.017),
                                    new Pose(98.911, 75.450),
                                    new Pose(91.629, 105.987)
                            )
                    ).setLinearHeadingInterpolation(Math.toRadians(40), Math.toRadians(40))
